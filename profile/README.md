...
| [**Cadence**](https://github.com/viberfasend/cadence) | Native Android and desktop todo app. Importance first, due date breaks ties, with recurrence that understands both calendar rules and "n days after completion". Quick add in English and German, tags, subtasks, attachments, widgets. Fully usable offline and signed out; sync is an optional sign-in against a Neon project you host yourself. | Kotlin · Compose Multiplatform · SQLDelight | [Android APK](https://github.com/viberfasend/cadence/releases/latest/download/cadence-release.apk) · [Desktop](https://github.com/viberfasend/cadence/releases/latest) |
