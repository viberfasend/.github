...
| [**Primico**](https://github.com/viberfasend/primico) | Native Android and desktop todo app. Importance first, due date breaks ties, with recurrence that understands both calendar rules and "n days after completion". Quick add in English and German, tags, subtasks, attachments, widgets. Fully usable offline and signed out; sync is an optional sign-in against a Neon project you host yourself. (Formerly Cadence.) | Kotlin · Compose Multiplatform · SQLDelight | [Website](https://viberfasend.github.io/primico/) · [Android APK](https://github.com/viberfasend/primico/releases/latest/download/primico-release.apk) |
